...
export default function Galleries() {
  ...
  async function removeGallery(gallery) {
    const ok = window.confirm(`Delete "${gallery.title || "Untitled Gallery"}" from client galleries?`);
    if (!ok) return;
