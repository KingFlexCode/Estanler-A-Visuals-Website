...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { label: "Total Inquiries", value: stats.inquiries, to: "/admin/inquiries", color: adminColors.text },
  ...
  return (
    <div style={{ minHeight: "100vh", background: adminColors.bg }}>
      ...
      <div style={{ padding: "2.5rem 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "1px", background: adminColors.border, marginBottom: "3rem" }}>
          {statCards.map(card => (
            <Link key={card.label} to={card.to} style={{ textDecoration: "none" }}>
              <div style={{
                ...
                onMouseLeave={e => e.currentTarget.style.background = adminColors.surface}
              >
                <div style={{
                  fontFamily: "'Playfair Display', serif",
                  fontWeight: 700,
