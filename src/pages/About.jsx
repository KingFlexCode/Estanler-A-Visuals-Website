...
export default function About() {
  return (
    <div style={{ background: COLORS.bg, minHeight: "100vh", paddingTop: "64px" }}>
      <div style={{ padding: "4rem clamp(1.5rem, 5vw, 4rem)", maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <Reveal delay={0.15}>
            ...
            <p style={{
              ...
              fontSize: "0.95rem", color: COLORS.muted, lineHeight: 1.9, marginBottom: "1.25rem",
            }}>
            ...
            <p style={{
              fontFamily: "'Inter', sans-serif", fontWeight: 300,
              fontSize: "0.95rem", color: COLORS.muted, lineHeight: 1.9, marginBottom: "2.5rem",
            }}>
        ...
        {/* Equipment */}
        <Reveal>
          <div style={{ borderTop: `1px solid ${COLORS.border}`, paddingTop: "4rem", marginBottom: "4rem" }}>
            <Tag>Equipment</Tag>
            <h2 style={{
              fontFamily: "'Playfair Display', serif", fontWeight: 700,
              fontSize: "1.8rem", color: COLORS.white, margin: "0.75rem 0 2rem",
            }}>The Kit</h2>
            <div style={{
              ...
              {[
                { cat: "Camera Bodies", items: ["Sony Alpha Series", "Sony A7 IV", "Sony FX3"] },
                { cat: "Lenses", items: ["Zeiss Batis 85mm", "Sony G-Master 24-70mm", "Sony 135mm f/1.8"] },
                { cat: "Lighting", items: ["Profoto B10 Plus", "Godox AD600", "Aputure 300D"] },
                { cat: "Post Production", items: ["Adobe Lightroom", "Adobe Premiere", "DaVinci Resolve"] },
              ].map(g => (
                <div key={g.cat} style={{ background: COLORS.bg, padding: "1.75rem" }}>
                  <div style={{
                  ...
                  {g.items.map(item => (
                    <div key={item} style={{
                      fontFamily: "'Inter', sans-serif", fontWeight: 300,
                      fontSize: "0.85rem", color: COLORS.muted, padding: "4px 0",
                    }}>{item}</div>
                  ))}
                </div>
              ))}
        ...
        <Reveal>
          <div style={{
            borderTop: `1px solid ${COLORS.border}`, paddingTop: "4rem",
            ...
            <a href="mailto:estanleraleman@gmail.com" style={{
              fontFamily: "'Inter', sans-serif", fontSize: "11px",
              letterSpacing: "0.14em", textTransform: "uppercase", fontWeight: 500,
              color: COLORS.muted, textDecoration: "none",
              borderBottom: `1px solid ${COLORS.border}`, paddingBottom: "2px",
            }}>estanleraleman@gmail.com</a>
          </div>
        </Reveal>
      </div>
      <Footer />
