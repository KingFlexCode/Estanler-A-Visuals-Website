...
const services = [
  {
    ...
    includes: ["Ceremony coverage", "Reception coverage", "Getting ready", "Portraits", "Online gallery", "Highlight reel available"],
  },
  {
    id: "quinceaneras", icon: "👑", label: "Quinceañeras",
    ...
    includes: ["Full day coverage", "Traditional ceremonies", "Court of honor", "Dance performances", "Family portraits", "Online gallery"],
  },
  {
    id: "portraits", icon: "🎞️", label: "Portraits",
    ...
    includes: ["1-4 hour sessions", "Multiple looks", "Location or studio", "Online gallery", "Retouched images", "Print-ready files"],
  },
  {
    ...
    includes: ["1-2 hour session", "Location of choice", "Online gallery", "Print-ready files"],
  },
  {
    id: "family", icon: "🌿", label: "Family Sessions",
    desc: "Lifestyle family photography — natural, relaxed, and authentic. Documenting your family as it is right now.",
    includes: ["1-2 hour session", "Lifestyle approach", "Online gallery", "Print-ready files"],
  },
  {
    id: "music", icon: "🎵", label: "Music Artists",
    desc: "Artist branding, EPKs, and album art. Visuals that define your brand and connect with your audience.",
    includes: ["EPK photography", "Album artwork", "Social content", "Press photos", "Online delivery"],
  },
  {
    ...
    includes: ["Product photography", "Brand campaigns", "Corporate headshots", "Event coverage", "Commercial licensing"],
  },
  {
    id: "film", icon: "🎬", label: "Film Production",
    desc: "Music videos, short films, and commercial productions. Full cinematic production from concept to final cut.",
    includes: ["Concept development", "Full production crew", "Cinematography", "Color grading", "Post-production", "Final delivery"],
  },
];
      ...
      <div style={{ padding: "4rem clamp(1.5rem, 5vw, 4rem)" }}>
        <Reveal>
          ...
          <p style={{
            ...
            fontSize: "1rem", color: COLORS.muted, maxWidth: "560px",
            lineHeight: 1.8, marginBottom: "4rem",
          }}>
            Every project is unique. Pricing is based on your specific needs —
            fill out the booking form and I'll put together a custom quote for you.
          </p>
        </Reveal>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "1px", background: COLORS.border }}>
          {services.map((s, i) => (
            <Reveal key={s.id} delay={i * 0.04}>
              <div style={{
                background: COLORS.bg, padding: "2.5rem 2rem",
              ...
              >
                ...
                <div style={{
                  ...
                  fontSize: "1.2rem", color: COLORS.white, marginBottom: "0.75rem",
                }}>{s.label}</div>
                <div style={{
                  fontFamily: "'Inter', sans-serif", fontWeight: 300,
                  fontSize: "0.88rem", color: COLORS.muted, lineHeight: 1.75,
                  marginBottom: "1.5rem",
                }}>{s.desc}</div>
                <div style={{ borderTop: `1px solid ${COLORS.border}`, paddingTop: "1.25rem" }}>
                  {s.includes.map(item => (
                    <div key={item} style={{
                      ...
                      fontFamily: "'Inter', sans-serif", fontWeight: 300,
                      fontSize: "0.82rem", color: COLORS.muted, padding: "4px 0",
                    }}>
        ...
        <Reveal>
          <div style={{
            textAlign: "center", marginTop: "5rem", padding: "4rem 2rem",
            ...
            <p style={{
              fontFamily: "'Inter', sans-serif", fontWeight: 300,
              fontSize: "0.95rem", color: COLORS.muted, maxWidth: "440px",
              margin: "0 auto 2rem", lineHeight: 1.75,
            }}>
              Fill out the booking form with your event details and I'll send you
            ...
            <Link to="/book" style={{
              ...
              padding: "14px 40px", textDecoration: "none", display: "inline-block",
